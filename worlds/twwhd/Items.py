...
ITEM_TABLE: dict[str, TWWHDItemData] = {
    "Telescope":                 TWWHDItemData("Item",      IC.useful,                       0,  1, 0x20, 0),
  # "Boat's Sail":               TWWHDItemData("Item",      IC.progression,                  1,  1, 0x78, 1),  # noqa: E131
    "Wind Waker":                TWWHDItemData("Item",      IC.progression,                  2,  1, 0x22, 2),
    "Grappling Hook":            TWWHDItemData("Item",      IC.progression,                  3,  1, 0x25, 3),
    "Spoils Bag":                TWWHDItemData("Item",      IC.progression,                  4,  1, 0x24, 4),
    "Boomerang":                 TWWHDItemData("Item",      IC.progression,                  5,  1, 0x2D, 5),
    "Deku Leaf":                 TWWHDItemData("Item",      IC.progression,                  6,  1, 0x34, 6),
    "Tingle Bottle":             TWWHDItemData("Item",      IC.filler,                       7,  1, 0x21, 7),
    "Iron Boots":                TWWHDItemData("Item",      IC.progression,                  8,  1, 0x29, 9),
    "Magic Armor":               TWWHDItemData("Item",      IC.progression,                  9,  1, 0x2A, 10),
    "Bait Bag":                  TWWHDItemData("Item",      IC.progression,                 10,  1, 0x2C, 11),
    "Bombs":                     TWWHDItemData("Item",      IC.progression,                 11,  1, 0x31, 13),
    "Delivery Bag":              TWWHDItemData("Item",      IC.progression,                 12,  1, 0x30, 18),
    "Hookshot":                  TWWHDItemData("Item",      IC.progression,                 13,  1, 0x2F, 19),
    "Skull Hammer":              TWWHDItemData("Item",      IC.progression,                 14,  1, 0x33, 20),
    "Power Bracelets":           TWWHDItemData("Item",      IC.progression,                 15,  1, 0x28, 0x145B7C36),

    "Hero's Charm":              TWWHDItemData("Item",      IC.useful,                      16,  1, 0x43, 0x145B7C38),
    ...
    "Triforce Shard 1":          TWWHDItemData("Item",      IC.progression,                 29,  1, 0x61, 0x145B7C3E),
    "Triforce Shard 2":          TWWHDItemData("Item",      IC.progression,                 30,  1, 0x62, 0x145B7C3E),
    "Triforce Shard 3":          TWWHDItemData("Item",      IC.progression,                 31,  1, 0x63, 0x145B7C3E),
    "Triforce Shard 4":          TWWHDItemData("Item",      IC.progression,                 32,  1, 0x64, 0x145B7C3E),
    "Triforce Shard 5":          TWWHDItemData("Item",      IC.progression,                 33,  1, 0x65, 0x145B7C3E),
    "Triforce Shard 6":          TWWHDItemData("Item",      IC.progression,                 34,  1, 0x66, 0x145B7C3E),
    "Triforce Shard 7":          TWWHDItemData("Item",      IC.progression,                 35,  1, 0x67, 0x145B7C3E),
    "Triforce Shard 8":          TWWHDItemData("Item",      IC.progression,                 36,  1, 0x68, 0x145B7C3E),
    ...
    "Nayru's Pearl":             TWWHDItemData("Item",      IC.progression,                 51,  1, 0x69, 0x145B7C3F),
    "Din's Pearl":               TWWHDItemData("Item",      IC.progression,                 52,  1, 0x6A, 0x145B7C3F),
    "Farore's Pearl":            TWWHDItemData("Item",      IC.progression,                 53,  1, 0x6B, 0x145B7C3F),

    "Progressive Sword":         TWWHDItemData("Item",      IC.progression,                 54,  4, 0x38, 0x145B7C34),
    "Progressive Shield":        TWWHDItemData("Item",      IC.progression,                 55,  2, 0x3B, 0x145B7C35),
    "Progressive Picto Box":     TWWHDItemData("Item",      IC.progression,                 56,  2, 0x23, 8),
    "Progressive Bow":           TWWHDItemData("Item",      IC.progression,                 57,  3, 0x27, 12),
    "Progressive Magic Meter":   TWWHDItemData("Item",      IC.progression,                 58,  2, 0xB1, 0x145B7B93),
    ...
    "Empty Bottle":              TWWHDItemData("Item",      IC.progression,                 62,  4, 0x50, 14),
    ...
    "Green Rupee":               TWWHDItemData("Item",      IC.filler,                     121,  1, 1, 0x145B7B84),
    "Blue Rupee":                TWWHDItemData("Item",      IC.filler,                     122,  2, 5, 0x145B7B84),
    "Yellow Rupee":              TWWHDItemData("Item",      IC.filler,                     123,  3, 10, 0x145B7B84),
    "Red Rupee":                 TWWHDItemData("Item",      IC.filler,                     124,  8, 20, 0x145B7B84),
    "Purple Rupee":              TWWHDItemData("Item",      IC.filler,                     125, 90, 50, 0x145B7B84),
    "Orange Rupee":              TWWHDItemData("Item",      IC.useful,                     126, 15, 100, 0x145B7B84),
    "Silver Rupee":              TWWHDItemData("Item",      IC.useful,                     127, 20, 200, 0x145B7B84),
    "Rainbow Rupee":             TWWHDItemData("Item",      IC.useful,                     128,  1, 500, 0x145B7B84),

    "Piece of Heart":            TWWHDItemData("Item",      IC.useful,                     129, 44, 0x01, 0x145B7B80),
    "Heart Container":           TWWHDItemData("Item",      IC.useful,                     130,  6, 0x04, 0x145B7B80),

    "Dragon Roost Cavern Big Key":               TWWHDItemData("Big Key",   IC.progression,                131,  1, 0x14),
    "Dragon Roost Cavern Small Key":             TWWHDItemData("Small Key", IC.progression,                132,  4, 0x13),
    "Forbidden Woods Big Key":                TWWHDItemData("Big Key",   IC.progression,                133,  1, 0x40),
    "Forbidden Woods Small Key":              TWWHDItemData("Small Key", IC.progression,                134,  1, 0x1D),
    "Tower of the Gods Big Key":              TWWHDItemData("Big Key",   IC.progression,                135,  1, 0x5C),
    "Tower of the Gods Small Key":            TWWHDItemData("Small Key", IC.progression,                136,  2, 0x5B),
    "Earth Temple Big Key":                TWWHDItemData("Big Key",   IC.progression,                138,  1, 0x74),
    "Earth Temple Small Key":              TWWHDItemData("Small Key", IC.progression,                139,  3, 0x73),
    "Wind Temple Big Key":                TWWHDItemData("Big Key",   IC.progression,                140,  1, 0x81),
    "Wind Temple Small Key":              TWWHDItemData("Small Key", IC.progression,                141,  2, 0x77),
    "Dragon Roost Cavern Dungeon Map":           TWWHDItemData("Map",       IC.filler,                     142,  1, 0x1B),
    "Dragon Roost Cavern Compass":               TWWHDItemData("Compass",   IC.filler,                     143,  1, 0x1C),
    "Forbidden Woods Dungeon Map":            TWWHDItemData("Map",       IC.filler,                     144,  1, 0x41),
    "Forbidden Woods Compass":                TWWHDItemData("Compass",   IC.filler,                     145,  1, 0x5A),
    "Tower of the Gods Dungeon Map":          TWWHDItemData("Map",       IC.filler,                     146,  1, 0x5D),
    "Tower of the Gods Compass":              TWWHDItemData("Compass",   IC.filler,                     147,  1, 0x5E),
    "Forsaken Fortress Dungeon Map":            TWWHDItemData("Map",       IC.filler,                     148,  1, 0x5F),
    "Forsaken Fortress Compass":                TWWHDItemData("Compass",   IC.filler,                     149,  1, 0x60),
    "Earth Temple Dungeon Map":            TWWHDItemData("Map",       IC.filler,                     150,  1, 0x75),
    "Earth Temple Compass":                TWWHDItemData("Compass",   IC.filler,                     151,  1, 0x76),
    "Wind Temple Dungeon Map":            TWWHDItemData("Map",       IC.filler,                     152,  1, 0x84),
    "Wind Temple Compass":                TWWHDItemData("Compass",   IC.filler,                     153,  1, 0x85),
